...
function make_slides(f) {
  ...
  slides.trial = slide({
        ...
        present : _.shuffle([ {
                  ...
                  {
                    utterance: "surface",
                    every: "None of the marbles are red.", some: "Not all of the marbles are red.", one: "There's a single marble that isn't red.", no: "All of the marbles are red."
                  },
                  {
                    utterance: "inverse",
                    every: "Not all of the marbles are red.", some: "None of the marbles are red.", one: "It's not the case that there's a single red marble.", no: "Some of the marbles are red."
                  }
        ])
        ,
        ...
        present_handle: function(stim) {
          ...
          var leftImage = "<img src=\"../1b/expt-files/images/" + stim.utterance + exp.condition + shuffleImages[0] + ".png\" class=\"image\"></img>";
          var rightImage = "<img src=\"../1b/expt-files/images/" + stim.utterance + exp.condition + shuffleImages[1] +".png\" class=\"image\"></img>";
...
function init() {
  // repeatWorker = false;
  // (function(){
  //   var ut_id = "intonation-ambiguity-20200429";
